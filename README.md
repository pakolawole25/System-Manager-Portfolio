...
![Latest HP servers, firewall, Cisco edge and distribution switches upgraded](./system-Manager-Portfolio/assets/project1-1.jpg)  
*Latest HP servers Firewall installed and configured*

![PCI DSS compliant Upgrade to Opera property management training including staff training on new features](./system-Manager-Portfolio/assets/project1-2.jpg)  
